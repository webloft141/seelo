  ...
  Future<void> _fetchTeam({bool retried = false}) async {
    ...
    if (user == null) {
      if (mounted) {
        setState(() {
          _loading = false;
          _error = 'Sign in required to view team workspace.';
        });
      }
      return;
    }
    try {
      ...
      if (res.statusCode == 200 && mounted) {
        ...
        setState(() {
          _loading = false;
          _error = 'Unable to load team data right now.';
        });
      }
    } catch (e, st) {
      logError(e, st);
      if (mounted) {
        setState(() {
          _loading = false;
          _error = 'Network error while loading team workspace.';
        });
      }
    }
  }
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '$_memberCount / $_maxMembers members',
                                style: const TextStyle(
                                  color: Color(0xFFA6A6A6),
                                  fontSize: 12,
                                ),
                  ...
                  if (isTeam) ...[
                    ...
                    if (_features.isEmpty)
                      Container(
                        ...
                        child: const Text(
                          'Team features will appear here',
                          style: TextStyle(
                            color: Color(0xFFA6A6A6),
                            fontSize: 13,
                          ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Get unlimited devices, shared sessions, and admin controls for your entire team.',
                            style: TextStyle(
                              color: Color(0xFFA6A6A6),
                              fontSize: 12,
                            ),
